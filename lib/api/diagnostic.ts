...
export const diagnosticApi = {
    ...
    async getTemplate(profileId: string) {
        return await apiClient.get<any>(`/diagnostic/child-profiles/${profileId}/template`);
    },
    ...
    async submitAttempt(profileId: string, payload: { templateId: string; answers: DiagnosticAnswer[] }) {
        return await apiClient.post<any>(`/diagnostic/child-profiles/${profileId}/attempts`, payload);
    },

    // GET /diagnostic/child-profiles/:profileId/history
    async getHistory(profileId: string) {
        return await apiClient.get<any>(`/diagnostic/child-profiles/${profileId}/history`);
    },

    // GET /diagnostic/attempts/:attemptId
    async getAttemptDetails(attemptId: string) {
        return await apiClient.get<any>(`/diagnostic/attempts/${attemptId}`);
    },
};
