        ...
        <section className="relative w-full bg-[#F4F7FE] py-12 md:py-20 overflow-hidden flex flex-col items-center justify-center font-sans">
            ...
            <div className="relative w-full max-w-6xl px-4 sm:px-6 lg:px-8 flex flex-col items-center min-h-[520px] sm:min-h-[600px] md:min-h-[680px] justify-center">
                ...
                <motion.div
                    ...
                    className="absolute top-2 left-2 sm:top-6 sm:left-4 md:top-8 md:left-10 lg:left-60 z-30 w-[100px] sm:w-[125px] md:w-[140px] bg-white rounded-xl border-2  overflow-hidden shadow-sm cursor-pointer"
                >
                ...
                <motion.div
                    ...
                    className="absolute bottom-12 left-2 sm:bottom-14 sm:left-4 md:bottom-16 md:left-10 lg:left-16 z-30 w-[130px] xs:w-[150px] sm:w-[175px] md:w-[195px] bg-white rounded-xl border border-gray-300 shadow-md p-1.5 cursor-pointer"
                >
                ...
                >
                    ...
                    <div className="flex items-center justify-between p-1.5 sm:p-2 rounded-xl  transition-colors cursor-pointer">
                    ...
                    <div className="flex items-center justify-between p-1.5 sm:p-2 rounded-xl hover:bg-gray-50 transition-colors cursor-pointer border-t border-gray-100">
                        <div className="flex items-center gap-2 sm:gap-2.5">
